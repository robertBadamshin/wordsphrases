package com.app.wordsphrases.words_stories_impl.presentation.view
...
class StoriesProgressView : LinearLayout {
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        ...
        progressColor = typedArray.getColor(
            R.styleable.StoriesProgressView_progressColor,
            defaultColor,
        )
        ...
        return object : PausableProgressBar.Callback {
            ...
            override fun onFinishProgress() {
                if (wasSkippedBackward) {
                    ...
                    storiesListener?.onPrev(current)
